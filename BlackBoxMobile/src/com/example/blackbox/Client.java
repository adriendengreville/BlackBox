...
public class Client  {
	...
	Cryptage clientKeys;	//module de cryptage/décryptage cété client
	...
	public boolean start() {	//Connexion au serveur
		...
		new ListenFromServer().start();	//on commence é écouter ce que dis le serveur
		
		try
		{
			sOutput.writeObject(username);		//premiére comm : envois du pseudo
		}
		catch (IOException eIO) {
