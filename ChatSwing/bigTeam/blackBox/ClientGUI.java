...
public class ClientGUI extends JFrame implements ActionListener {
	...
	//ATTRIBUTS
		private JFrame frame;									//la fenêtre principale
		...
		Font tmpFont = null;									//les polices de caractères custom qui seront inclues en ressources
		Font customLabels = null;
		Font customTitle = null;
	
		int pX, pY;												//les variables pour le déplacement de la fenêtre (positions actuelles)
...
//			PromptSupport.setPrompt("IP", ipField);
		...
		void connectionFailed() {	//pour que le client puisse signaler un problème de connection
		...
		public void actionPerformed(ActionEvent e) {	//gestion des boutons		    
			...
			if(o == joinNetwork) {		//si ça vient du bouton de connexion
				...
				ipField.setEditable(false);							//on règles les boutons et champs de l'UI pour qu'ils se comportent logiquement
